          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <div className="bg-bg-secondary p-6 rounded-lg">
                <p className="text-secondary mb-2"><strong>Digital Mosaic Studios</strong></p>
                <p className="text-secondary mb-2">Email: taronjiandrew@gmail.com</p>
                <p className="text-secondary mb-2">Phone: 404-861-7744</p>
                <p className="text-secondary">Website: digitalmosaicstudios.com</p>
              </div>
            </div>
