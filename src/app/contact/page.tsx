  ...
  return (
    <>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                    <div className="w-10 h-10 flex items-center justify-center bg-bg-secondary rounded-full">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-secondary text-sm">taronjiandrew@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-secondary text-sm">404-861-7744</p>
                  </div>
                </div>
      ...
      <section className="py-12 bg-bg-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative h-96 w-full rounded-lg overflow-hidden shadow-subtle">
            <div className="absolute inset-0 bg-white flex items-center justify-center">
              <div className="text-center p-6">
                ...
                <p className="text-primary text-lg font-medium">VentureGrowth Marketing - Marietta, GA 30062</p>
