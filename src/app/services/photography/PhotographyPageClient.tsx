        ...
        <div className="relative z-10">
          ...
          <section className="relative text-white min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
              ...
              <span className="inline-block px-4 py-1.5 mb-6 text-xs font-figtree font-semibold tracking-widest uppercase text-accent border border-accent/40 rounded-full bg-accent/10">
                New Service
              </span>
              ...
              <p
                className="text-lg sm:text-xl md:text-2xl text-white/85 font-figtree font-medium max-w-3xl mx-auto leading-relaxed mb-10"
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                ...
                <Link
                  href="/contact"
                  className="px-8 py-4 font-figtree font-semibold rounded-full bg-transparent border-2 border-white text-white hover:bg-white hover:text-primary transition-all duration-200 transform hover:scale-105 text-base"
                >
                  Book a Consultation
                </Link>
              </div>
          ...
          {/* ─── What's Included (SEO Bundle) ─── */}
          <section className="py-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-14">
                <h2 className="font-figtree text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
                  Every Package Includes Full SEO Optimization
                </h2>
                <p className="text-white/70 font-figtree text-lg max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {seoFeatures.map((feature, i) => (
                  ...
                  >
                    ...
                    <h3 className="font-figtree font-semibold text-white text-lg mb-2">{feature.title}</h3>
                    <p className="font-figtree text-white/65 text-sm leading-relaxed">{feature.description}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <section id="packages" className="py-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-14">
                ...
                <p className="text-white/70 font-figtree text-lg max-w-xl mx-auto">
                ...
                {packages.map((pkg, i) => (
                  <div
                    ...
                    className={`relative flex flex-col rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1 ${
                      pkg.highlight
                        ? 'bg-accent border-2 border-accent shadow-2xl scale-105 md:scale-105'
                        : 'bg-white/5 border border-white/10 hover:border-accent/40'
                    }`}
                  >
                    {pkg.badge && (
                      <div className={`absolute top-0 left-0 right-0 text-center py-1.5 text-xs font-figtree font-bold tracking-widest uppercase ${
                    ...
                    <div className={`p-8 flex flex-col flex-grow ${pkg.badge ? 'pt-10' : ''}`}>
                      {/* Package name & price */}
                      <div className="mb-6">
                        <h3 className={`font-figtree font-bold text-xl mb-1 ${pkg.highlight ? 'text-white' : 'text-white'}`}>
                          {pkg.name}
                        </h3>
                        <div className="flex items-end gap-1 mb-3">
                          ...
                          <span className={`font-figtree text-sm mb-1 ${pkg.highlight ? 'text-white/70' : 'text-white/50'}`}>
                            flat rate
                          </span>
                        </div>
                        <div className={`inline-flex items-center gap-2 text-sm font-figtree font-medium ${pkg.highlight ? 'text-white/80' : 'text-white/60'}`}>
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                          </svg>
                          {pkg.duration}
                        </div>
                        <div className={`flex items-center gap-2 text-sm font-figtree font-medium mt-1 ${pkg.highlight ? 'text-white/80' : 'text-white/60'}`}>
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <p className={`font-figtree text-sm leading-relaxed mb-6 ${pkg.highlight ? 'text-white/80' : 'text-white/55'}`}>
                        {pkg.description}
                      </p>
                      ...
                      <ul className="space-y-2.5 mb-8 flex-grow">
                        {pkg.features.map((feature, j) => (
                          <li key={j} className="flex items-start gap-2.5">
                            ...
                            <span className={`font-figtree text-sm ${pkg.highlight ? 'text-white/90' : 'text-white/70'}`}>
                              {feature}
                            </span>
                          </li>
                        ))}
                      ...
                      <Link
                        href="/contact"
                        className={`block text-center px-6 py-3.5 font-figtree font-semibold rounded-full transition-all duration-200 transform hover:scale-105 text-sm ${
                          pkg.highlight
                            ? 'bg-white text-accent hover:bg-white/90'
                            : 'bg-accent text-white hover:bg-light-accent'
                        }`}
                      >
                        {pkg.cta}
                      </Link>
              ...
              <p className="text-center text-white/40 font-figtree text-sm mt-8">
                All packages include travel within metro Atlanta. Additional travel fees may apply outside the Atlanta metro area. Contact us for a custom quote.
              </p>
            </div>
          </section>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12">
                <div className="grid md:grid-cols-2 gap-10 items-center">
                  <div>
                    <h2 className="font-figtree text-2xl sm:text-3xl font-bold text-white mb-5">
                      Why Photos + SEO Together?
                    </h2>
                    <p className="text-white/70 font-figtree text-base leading-relaxed mb-4">
                      A beautiful photo that isn't optimized is invisible to search engines. Most businesses pay a photographer, then have to hire an SEO specialist separately — and even then, image optimization is often skipped.
                    </p>
                    <p className="text-white/70 font-figtree text-base leading-relaxed mb-4">
                    ...
                    <p className="text-white/70 font-figtree text-base leading-relaxed">
                      The result: faster pages, better rankings, and imagery that works as hard as you do.
                    </p>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      { stat: '20+', label: 'Photos Starter Package' },
                      { stat: '40+', label: 'Photos Growth Package' },
                      ...
                      <div key={i} className="bg-white/5 border border-white/10 rounded-2xl p-5 text-center">
                        ...
                        <div className="font-figtree text-xs text-white/55 font-medium uppercase tracking-wider">{item.label}</div>
                      </div>
                    ))}
                  </div>
                </div>
