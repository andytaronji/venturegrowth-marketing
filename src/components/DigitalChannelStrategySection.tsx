...
const DigitalChannelStrategySection = () => {
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          ...
          style={{'--accent': '#5b9dff', '--line': 'rgba(91,157,255,.30)', '--glow': 'rgba(91,157,255,.15)'} as React.CSSProperties}
        >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 md:order-1 dms-content">
                  <div className="dms-kicker">
                    ...
                    <span className="txt">Service 03 / 06</span>
                  </div>
                  <h2 className="dms-title">Digital Channel Strategy</h2>
                  <p className="dms-desc">
                    Develop a comprehensive multi-channel digital presence that reaches your audience where they are. We create integrated strategies across social media, content platforms, email, and digital advertising to maximize your impact.
                  </p>
                  <ul className="dms-list">
                    <li><span className="chip">{checkSvg}</span><span className="label">Multi-Channel Presence</span></li>
                    <li><span className="chip">{checkSvg}</span><span className="label">Channel Integration</span></li>
                    <li><span className="chip">{checkSvg}</span><span className="label">Strategic Execution</span></li>
                  </ul>
                  <div className="mt-8">
                ...
                <div className="order-2 md:order-2">
                  <div className="dms-panel">
                    <dms-anim kind="channel" aria-hidden="true"></dms-anim>
...
export default DigitalChannelStrategySection;
