              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 md:order-1">
                  ...
                  <p className="text-lg text-white text-opacity-90 mb-6">
                    Develop a comprehensive multi-channel digital presence that reaches your audience where they are. We create integrated strategies across social media, content platforms, email, and digital advertising to maximize your impact and drive measurable results.
                  </p>
                ...
                <div className="relative h-96 w-full order-2 md:order-2">
                  <div className="relative h-full w-full overflow-hidden rounded-lg">
                    <CldImageWrapper
                      ...
                      alt="Digital Channel Strategy Services"
                      width={800}
                      height={600}
                      crop="fit"
                      gravity="auto"
