...
const AiPromptingLessonsSection = () => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-2 md:order-2">
                  ...
                  <p className="text-lg text-white text-opacity-90 mb-6">
                    Learn to leverage AI tools for marketing, content creation, and workflow automation through local workshops and virtual sessions for Georgia businesses. Discover the business impact of effective AI communication.
                  </p>
                ...
                <div className="relative h-96 w-full order-1 md:order-1">
                  <div className="relative h-full w-full overflow-hidden rounded-lg">
                    <CldImageWrapper
                      src="https://res.cloudinary.com/di4phdven/image/upload/v1752192346/u9524928111_A_bright_modern_classroom_of_students_at_laptops__7b221d44-61f0-42d5-ac95-a2f82d38ee17_0_afy8gt.png"
                      alt="AI Prompting Lessons Services"
                      width={800}
                      height={600}
                      crop="fit"
                      gravity="auto"
...
export default AiPromptingLessonsSection;
