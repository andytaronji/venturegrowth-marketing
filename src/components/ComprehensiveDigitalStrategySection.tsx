...
const ComprehensiveDigitalStrategySection = () => {
  ...
  const features = [
    {
      title: "Full-Scale Strategy Development"
    },
    {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-2 md:order-2">
                  <h2 className="text-3xl font-bold text-white mb-6">
                    Comprehensive Digital Strategy Execution & Management
                  </h2>
                ...
                <div className="relative h-96 w-full order-1 md:order-1">
                  <div className="relative h-full w-full overflow-hidden rounded-lg">
                    <CldImageWrapper
                      ...
                      alt="Comprehensive Digital Strategy Execution & Management Services"
                      width={800}
                      height={600}
                      crop="fit"
                      gravity="auto"
