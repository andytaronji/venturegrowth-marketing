...
const EnhancedServicesSection = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      title: 'Measurement & Optimization Framework',
    ...
    },
    {
      ...
      title: 'Comprehensive Digital Strategy Execution & Management',
      ...
      <div className="max-w-7xl mx-auto container-padding">
        <div ref={headerRef} className="section-header animate-header text-center mb-12 md:mb-16">
          <h2 className="font-figtree text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-6 leading-tight">
            Your Partners in Strategy
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-white max-w-4xl mx-auto font-figtree leading-relaxed px-4">
            Think of us as the <span className="text-accent font-semibold">blueprint</span> for your business. We create your <span className="text-accent font-semibold">digital roadmap</span>, offering you strategies that cover any of the following aspects of your industry:
          </p>
        </div>
