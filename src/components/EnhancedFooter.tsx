...
const EnhancedFooter = () => {
  ...
  return (
    <footer 
      ref={footerRef}
      className="bg-bg-secondary text-primary border-t border-bg-secondary z-index-section"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          >
            ...
            <div className="mt-6 flex space-x-4">
              <a 
                href="#" 
                className="social-icon text-secondary-light hover:text-accent transition-colors duration-200 gsap-will-change"
              >
        ...
        <div 
          ref={copyrightRef}
          className="mt-8 pt-8 border-t border-bg-tertiary text-center gsap-will-change"
        >
