          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start hover:translate-x-1 transition-transform duration-300">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-white text-opacity-80 text-sm">Based in Georgia</p>
            ...
            <div className="mt-8">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p className="text-white" style={{ color: '#ffffff !important' }}>Saturday: 10:00 AM - 4:00 PM</p>
                <p className="text-white" style={{ color: '#ffffff !important' }}>Sunday: Closed</p>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-white text-opacity-80 hover:text-accent transition-colors duration-200">
