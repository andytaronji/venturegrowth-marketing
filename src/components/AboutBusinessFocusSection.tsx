...
const AboutBusinessFocusSection = () => {
  ...
  const features = [
    ...
    {
      title: "Unique and Tailored Consultations"
    }
  ];
            ...
            <div className="p-8 md:p-12">
              ...
              <div className="order-1 md:order-1">
                <h2 className="text-3xl font-bold text-white mb-6">
                  Why We Focus on Small Business & Startup Growth
                </h2>
                <p className="text-lg text-white text-opacity-90 mb-6">
                  We believe that, through helping the community and the small businesses that operate within it, we can create opportunities and partnerships that would not have been possible otherwise.
                </p>
                <p className="text-lg text-white text-opacity-90 mb-6">
                  This is what keeps us passionate.
                </p>
              ...
              <div className="relative h-96 w-full order-2 md:order-2">
                <div className="relative h-full w-full overflow-hidden rounded-lg">
                  <CldImageWrapper
                    src="u9524928111_A_crisp_professional_mosaic-style_timeline_beside_a26591de-e997-440a-a17c-edbf4462fc63_1_tnxl1s"
                    alt="Digital Mosaic Studios Blue-Collar Expertise"
                    width={800}
                    height={600}
                    crop="fit"
                    gravity="auto"
...
export default AboutBusinessFocusSection;
