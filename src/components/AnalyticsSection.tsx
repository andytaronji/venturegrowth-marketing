              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 md:order-1">
                  ...
                  <p className="text-lg text-white text-opacity-90 mb-6">
                    Our analytics help Atlanta and Georgia businesses make data-driven decisions. We use Google Analytics and custom dashboards to provide comprehensive insights tailored for local market performance.
                  </p>
                ...
                <div className="relative h-96 w-full order-2 md:order-2">
                  <div className="relative h-full w-full overflow-hidden rounded-lg">
                    <CldImageWrapper
                      src="https://res.cloudinary.com/di4phdven/image/upload/v1752192346/u9524928111_Futuristic_modular_UI_panels_and_code_snippets_fl_a76642d7-73db-4b3b-9018-4cedc4e8015a_3_ds0rbi.png"
