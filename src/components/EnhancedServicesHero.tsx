...
const EnhancedServicesHero = ({
  ...
  useEffect(() => {
    if (heroRef.current && gsap && titleRef.current && descriptionRef.current) {
      // Home page hero-style animation with staggered text reveals
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center">
          <h1 
            ref={titleRef}
            className="font-figtree text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-6"
          ...
          <p 
            ref={descriptionRef}
            className="text-base sm:text-lg md:text-xl text-white font-figtree font-medium max-w-4xl mx-auto leading-relaxed"
